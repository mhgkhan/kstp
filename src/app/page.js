        ...
        <article>
          <section className="w-full bg-cyan-900">
            <div className="container mx-auto flex md:flex-row-reverse flex-col items-start justify-between">
              <div className="md:p-0 p-2 flex md:flex-row-reverse flex-col items-center justify-between">
                {/* <object role="banner" aria-labelledby="label" data="Hero.svg" type="image/svg+xml"  className="md:w-[45%] w-[70%] mx-auto"></object> */}
                <Image loading="lazy" role="img" aria-labelledby="label" src="/Hero.svg" alt="KSTP Landscape Image" width={300} height={300} className="md:w-[35%] w-[70%] mx-auto" />
                <div className="flex flex-col md:text-left md:items-start justify-center md:py-20 py-2 md:w-[50%] w-[97%] md:mx-0 mx-auto">
                  ...
                  <h1 role="heading" aria-level={2} className={`md:text-4xl text-3xl font-bold text-white md:text-left text-center ${Signika_Font.className}`}>KHYBER STUDENTS TESTING PORTAL</h1>
                  <p className="md:text-lg text-sm my-3 md:text-justify text-center text-gray-200">
                  Welcome to the Khyber Students Testing Portal (KSTP), your go-to platform for test preparations. Enhance your skills and knowledge with our tailored challenges and exercises. Join us today and excel in your academic and professional journey.
                    </p>
