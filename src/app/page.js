          ...
          <section className="w-full bg-cyan-900">
            <div className="container mx-auto flex md:flex-row-reverse flex-col items-start justify-between">
              <div className="md:p-0 p-2 flex md:flex-row-reverse flex-col items-start justify-between">
                <object  data="Hero.svg" type="image/svg+xml"  className="md:w-[45%] w-[70%] mx-auto"></object>
                <div className="flex flex-col md:text-left md:items-start justify-center md:py-20 py-2 md:w-[50%] w-[97%] md:mx-0 mx-auto">
                  ...
                  <div className="buttons-container md:mx-0 mx-auto flex items-start flex-wrap justify-start gap-4 md:mt-5 mt-3">
                    <Link href={"/login"} className="md:p-4 p-3 w-auto rounded-md bg-cyan-950 text-white hover:bg-white hover:text-cyan-950 border border-1 border-cyan-600 hover:border-cyan-950 font-bold "> Candidate Login </Link>
                    <Link href={"/tests"} className="md:p-4 p-3 w-auto rounded-md bg-cyan-950 text-white hover:bg-white hover:text-cyan-950 border border-1 border-cyan-600 hover:border-cyan-950 font-bold mx-1"> Opened Tests </Link>
                  </div>
                </div>
              </div>
            </div>
