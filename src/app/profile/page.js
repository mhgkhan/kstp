    ...
    <section className="my-2 w-full bg-white mt-4">
      <div className="container mx-auto">
        ...
        <div className="blocks flex flex-wrap items-center justify-start gap-1">
          {
            Array.from([
              { link: "/profile/tests/submittedtests/", icon: <AiOutlineLoading3Quarters />, count: 20, text: "Tests Submitted" },
              { link: "/profile/tests/passedtests/", icon: <TiTickOutline />, count: 10, text: "Tests Passed" },
              { link: "/profile/tests/achevements/", icon: <FaTrophy />, count: 15, text: "Positions acheived" }
            ]).map((ele, ind) => {
